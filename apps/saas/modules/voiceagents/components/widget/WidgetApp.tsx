...
/**
 * Non-audio visualizer variants (pulse / waveform / dots). Shared with the
 * Studio preview via the same markup so what the merchant picks matches what
 * ships. `active` drives the animation intensity.
 */
